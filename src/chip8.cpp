...
void chip8::table0() { ((*this).*(tableGroup0[opcode & 0x000F]))(); }

void chip8::table8() { ((*this).*(tableGroup8[opcode & 0x000F]))(); }

void chip8::tableE() { ((*this).*(tableGroupE[opcode & 0x000F]))(); }

void chip8::tableF() { ((*this).*(tableGroupF[opcode & 0x00FF]))(); }
